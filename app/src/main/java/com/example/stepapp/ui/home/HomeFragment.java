...
//
//    private void insertStepsForAWeek(){
//        ContentValues values = new ContentValues();
//        long now = Calendar.getInstance().getTimeInMillis();
//        final  int MILL_IN_DAY = 1000*60*60*24;
//        List<Long> selectedDatesInMills = new ArrayList<Long>();
//        for(int i = 0; i < 7; i++){
//            selectedDatesInMills.add(now - MILL_IN_DAY*i);
//        }
//
//        long timeInMillis = System.currentTimeMillis() + (event.timestamp - SystemClock.elapsedRealtimeNanos()) / 1000000;
//
